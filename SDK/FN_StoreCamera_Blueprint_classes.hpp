...
public:
	...
	bool                                               CameraInStartPos;                                         // 0x0928(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	bool                                               MouseDown;                                                // 0x0929(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	static UClass* StaticClass()
	{
		...
		if (!ptr) ptr = UObject::FindClass(0xb1c1e9f5);
		return ptr;
	}
