...
public:
	...
	bool                                               ShouldLoop;                                               // 0x0270(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               AutoPlay;                                                 // 0x0271(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	bool                                               MaintainAspectRatio;                                      // 0x0272(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	...
	static UClass* StaticClass()
	{
		...
		if (!ptr) ptr = UObject::FindClass(0x34902695);
		return ptr;
	}
