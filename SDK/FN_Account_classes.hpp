...
public:
	...
	bool                                               bRequireLightswitchAtStartup;                             // 0x0048(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	...
	bool                                               bShouldGrantFreeAccess;                                   // 0x0070(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0071(0x0001) MISSED OFFSET
	bool                                               bUseGameSubAccessRedemption;                              // 0x0072(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	bool                                               bAllowHomeSharingAccess;                                  // 0x0073(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      UnknownData03[0x78C];                                     // 0x0074(0x078C) MISSED OFFSET

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr) ptr = UObject::FindClass(0x4a4506d7);
		return ptr;
	}
