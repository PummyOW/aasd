...
struct FEventRecord
{
	struct FString                                     EventName;                                                // 0x0000(0x0010) (CPF_ZeroConstructor)
...
struct FEventChannelState
{
	...
	TArray<struct FEventRecord>                        ActiveEvents;                                             // 0x0008(0x0010) (CPF_ZeroConstructor)
...
struct FEventsTimeline
{
	...
	TArray<struct FEventChannelState>                  States;                                                   // 0x0008(0x0010) (CPF_ZeroConstructor)
};
...
struct FCalendarDownload
{
	...
	TMap<struct FString, struct FEventsTimeline>       Channels;                                                 // 0x0008(0x0050) (CPF_ZeroConstructor)
};
