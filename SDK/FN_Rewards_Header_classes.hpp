...
public:
	...
	bool                                               UseSubHeader;                                             // 0x0260(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	...
	static UClass* StaticClass()
	{
		...
		if (!ptr) ptr = UObject::FindClass(0xb6790245);
		return ptr;
	}
